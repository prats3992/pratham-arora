...
export const metadata: Metadata = {
  title: "Resume",
  description:
    "Résumé of Pratham Arora — final-year CS & AI student at Plaksha University. Three tailored versions available: Master Resume, SDE-focused (backend, full-stack, fintech), and AI/ML-focused (RAG pipelines, LLM systems, research).",
}
      ...
      <section className="pt-8 md:pt-16">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <DownloadLink
            href="/aiml.pdf"
            label="AI/ML Resume"
            descriptor="Research, RAG pipelines & LLM systems"
          />
        </div>
      </section>
...
function DownloadLink({
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {descriptor && (
        <span className="text-2xs text-[var(--text-tertiary)] pl-1">{descriptor}</span>
      )}
    </div>
  )
}
