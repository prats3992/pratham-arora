...
% \begin{itemize}
%     \item \textbf{P.\ Arora}, A.\ Lodha, S.\ Siddharth. ``Wait for It: A Component-Level Analysis of Latency Feedback Mechanisms for LLM Agents in VR.'' \textit{Under review, MIT Presence}, 2026.
% \end{itemize}
%
